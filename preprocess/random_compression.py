...
def init_8Diffusions(mode:str, ratio:float, down:int, up:int):
...
def init_5Diffusions(mode:str, ratio:float, down:int, up:int):
...
def init_ProGan(mode:str, data_type:str, ratio:float, down:int, up:int):
    ...
    dataroot = 'your path/{}/NoCmp'.format(data_type)
...
def main(args):
    ...
    elif args.dataset == '8Diffusions':
        init_8Diffusions(args.mode, args.ratio, args.down, args.up)
    elif args.dataset == '5Diffusions':
        init_5Diffusions(args.mode, args.ratio, args.down, args.up)
    else:
        NotImplementedError
